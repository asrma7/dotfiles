...
-- Custom telescope keybinding to find files and open them in a vertical split with <leader>fv in normal mode
...
-- Custom telescope keybinding to find files and open them in a horizontal split with <leader>fs in normal mode
